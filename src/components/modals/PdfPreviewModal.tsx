  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 h-[85vh] flex flex-col">
      ...
      <div className="flex-grow relative">
        {isLoading && (
          <div className="absolute inset-0 flex flex-col justify-center items-center bg-white dark:bg-gray-800 rounded">
        ...
        <iframe
          ...
          width="100%"
          height="100%"
          className={`border border-gray-300 dark:border-gray-700 rounded transition-opacity duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'}`}
