  ...
  const liClasses = useMemo(() => {
    ...
    switch (assignment.status) {
      case AssignmentStatus.Yes:
        return `${base} bg-success/60 text-success-foreground ${borderClasses}`;
      case AssignmentStatus.Pending:
        return `${base} bg-warning/60 text-warning-foreground ${borderClasses}`;
      case AssignmentStatus.No:
        return `${base} bg-destructive/60 text-destructive-foreground ${borderClasses}`;
