  ...
  return (
    <div className="space-y-4 p-4 bg-card border border-border rounded-lg">
      <div className="flex items-center justify-between mb-4">
        ...
        <Tooltip text={t('rider_workshop.reset_options_tooltip')}>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_basic_info_tooltip')}>
            <input
              type="checkbox"
              id="includeBasicInfo"
        ...
        {/* Inputs */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_inputs_tooltip')}>
            <input
              type="checkbox"
              id="includeInputs"
        ...
        {/* Technical Notes */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_technical_notes_tooltip')}>
            <input
              type="checkbox"
        ...
        {/* Hospitality */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_hospitality_tooltip')}>
            <input
              type="checkbox"
        ...
        {/* General Notes */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_general_notes_tooltip')}>
            <input
              type="checkbox"
        ...
        {/* Monitors */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_monitors_tooltip')}>
            <input
              type="checkbox"
              id="includeMonitors"
        ...
        {/* Cablejat */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_cable_tooltip')}>
            <input
              type="checkbox"
              id="includeCable"
        ...
        {/* Material Spare */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.include_spare_tooltip')}>
            <input
              type="checkbox"
              id="includeSpare"
        ...
        {/* Show Empty Sections */}
        <div className="flex items-center space-x-2">
          <Tooltip text={t('rider_workshop.show_empty_sections_tooltip')}>
            <input
              type="checkbox"
      ...
      <div className="flex justify-end pt-4 border-t border-border">
        <Tooltip text={t('rider_workshop.export_custom_pdf_tooltip')}>
          <button
            onClick={onExport}
            disabled={disabled}
