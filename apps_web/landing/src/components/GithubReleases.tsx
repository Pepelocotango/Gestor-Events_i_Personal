    ...
    return (
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
        <div className="md:col-span-2 lg:col-span-4 bg-amber-900/30 p-6 rounded-xl border border-amber-700/50">
          <h3 className="text-lg font-semibold text-amber-300 mb-2">No hem pogut obtenir les últimes versions</h3>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
      ...
      {renderPlatformCard(
        ...
        <svg role="img" className="w-12 h-12 mb-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <title>Linux</title>
          <defs>
            <style>{`.linux-dark { fill: #000000; } .linux-light { fill: #ffffff; }`}</style>
          </defs>
          <g className="linux-light">
