...
const formatDateRangeFromData = (data) => {
 ...
 */
const generateSmartDescriptor = (filters, data) => {
 ...
 */
export const generateFileName = (prefix, filters, data, extension) => {
 ...
 */
export const generateTechSheetFileName = (eventName, eventDateOrRange) => {
