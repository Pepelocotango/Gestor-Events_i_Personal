...
export const escapeCsvCell = (cellData) => {
...
export const exportEventListToCsv = (eventFrames, peopleGroups, activeFilters) => {
    const headers = [
        'Nom Esdeveniment',
        'Lloc',
...
export const exportMaterialControlCsv = (data) => {
