...
export const exportMaterialToPdf = (materialItems: MaterialItem[]) => {
  const pdf = new jsPDF('p', 'mm', 'a4');
...
export const exportMaterialControlSummaryPdf = (
...
export const exportMaterialControlDetailedPdf = (
  data: MaterialControlRow[],
...
export const exportPeopleToPdf = (peopleGroups: PersonGroup[]) => {
  const pdf = new jsPDF('p', 'mm', 'a4');
