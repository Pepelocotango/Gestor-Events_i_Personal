...
export let persistenceAdapter: PersistenceAdapter | null = null;
...
interface EventDataActions {
    ...
    exportData: () => Promise<Omit<AppData, 'googleConfig'>>;
    ...
    // Funcions opcionals que seran implementades per l'extensió d'escriptori
