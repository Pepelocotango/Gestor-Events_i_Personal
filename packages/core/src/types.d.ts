...
export interface TechSheetData {
    ...
    logistics?: ConditionalSection;
    dressingRooms?: ConditionalSection<{
        details: string;
    }>;
    actorsInfo?: ConditionalSection<{
        number: number | string;
        names: string;
    }>;
    techniciansInfo?: ConditionalSection<{
        number: number | string;
        names: string;
    }>;
    lighting?: ConditionalSection<{
        needs: NeedItem[];
    }>;
    sound?: ConditionalSection<{
        needs: NeedItem[];
    }>;
    video?: ConditionalSection<{
        needs: NeedItem[];
    }>;
    machinery?: ConditionalSection<{
        needs: NeedItem[];
    }>;
    ...
    showTechnicalNeedsInPdf?: boolean;
...
export type ModalType = 'addEventFrame' | 'editEventFrame' | 'addAssignment' | 'editAssignment' | 'managePeople' | 'eventFrameDetails' | 'confirmDeleteEventFrame' | 'confirmDeleteAssignment' | 'googleSettings' | 'confirmHardReset' | 'mergeOrReplace' | 'selectSyncCalendar' | 'createAppCalendar' | 'confirmDataRepair' | 'confirmDuplicate' | 'updateFromAssignments' | 'addMaterialFromTechSheet' | 'confirmDelete' | 'history' | 'googleEventDetails' | 'about' | null;
...
export interface EventDataConteImplicits {
    ...
    googleEvents: any[];
    refreshGoogleEvents: (showToast?: ShowToastFunction) => Promise<{
        success: boolean;
        message?: string;
...
export interface ElectronAPI {
    ...
    getEventDetails: (calendarId: string, eventId: string) => Promise<{
        success: boolean;
        event?: any;
        message?: string;
    }>;
    ...
    deleteAppCalendar: (calendarId: string) => Promise<{
        success: boolean;
        message?: string;
        data?: {
            managedAppCalendars: ManagedAppCalendar[];
    ...
    createNewAppCalendar: (suffix: string) => Promise<{
        success: boolean;
        message?: string;
        data?: {
            managedAppCalendars: ManagedAppCalendar[];
    ...
    saveAppData: (data: AppData) => Promise<{
        success: boolean;
        message?: string;
    }>;
